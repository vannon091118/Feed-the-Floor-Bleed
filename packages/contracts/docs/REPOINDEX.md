...
| Pfad | Job |
|------|-----|
| `packages/contracts/src/version.ts` | Contract-v2- und Simulationsversion |
...
| `packages/contracts/src/combat-log.ts` | Strikte Wire-Form von Config, Einheiten, Events, Log und Summary |
...
| `packages/contracts/test/raid-snapshot.test.ts` | Vollständige Freeze-Daten und v2-Grenzen |
...
| `packages/contracts/test/raid-fixtures.ts` | Gültige v2-Test-Snapshots, Logs und Jobs |
